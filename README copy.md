...
:information_source: &nbsp;此仓库包含有关各种技术主题的问题和练习，有时与DevOps和SRE有关 :)

:bar_chart: &nbsp;当前有 **1203** 个问题

:busts_in_silhouette: &nbsp;[加入](https://www.facebook.com/groups/538897960007080) 我们的 [Facebook group](https://www.facebook.com/groups/538897960007080) 或在 [Twitter](https://twitter.com/devopsbit) 上关注我们，以获取有关DevOps的其他日常练习，文章和更多资源

:warning: &nbsp;你可以使用这些来准备面试，但是大多数问题和练习并不代表实际的面试。请阅读 [Q&A](common-qa.md) 以获取更多详细信息

:thought_balloon: &nbsp;如果你想知道"如何为DevOps面试做准备?", 你可能想在这里阅读我的一些建议在[这里](prepare_for_interview.md)
...
<table>
  <tr>
    <td align="center"><a href="#devops"><img src="images/devops.png" width="70px;" height="75px;" alt="DevOps" /><br /><b>DevOps</b></a><br /><sub><a href="#devops-beginner">初级 :baby:</a></sub><br><sub><a href="#devops-advanced">高级 :star:</a></sub></td>
...
<summary>Which of the following are AWS accounts types (and are sorted by order)?
  ...
  * 初级, Pro, Intermediate Enterprise</summary><br><b>
...
<details>
<summary>What is Azure 高级 Threat Protection?</summary><br><b>
</b></details>
...
#### OpenStack 高级 - Networking (Neutron)
